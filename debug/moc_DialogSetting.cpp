...
**
** Created: Mon Dec 19 18:47:28 2011
...
static const char qt_meta_stringdata_DialogSetting[] = {
    "DialogSetting\0"
};
...
const QMetaObjectExtraData DialogSetting::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DialogSetting::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogSetting,
      qt_meta_data_DialogSetting, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DialogSetting::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DialogSetting))
